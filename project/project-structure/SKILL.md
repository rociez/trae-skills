...
### 输出数据模型设计
1. 读取 [[`data-model-design-template.md`](https://github.com/rociez/trae-skills/blob/main/template/data-model-design-template.md)] 作为生成基准
2. 检查 `/output` 目录是否存在，若不存在请自动创建
3. 填好后保存为 `/output/数据模型设计.md`
